...
function simTwoPopHemiInput_privateNoise(T,Ne,Ni,N0,K,KI,Nepop,Nipop,N0pop,tauerise,tauedecay,tauirise,tauidecay,taue,taui, sigma0, JR)
	...
	sqrtK = 0.9 * K#sqrt(K) #K * 4.0 #sqrt(K)
	...
	return times,ns,times0,ns0,Ne,Ncells,T,weights,synInputPerNeuronOverTime,voltageOverTime, privNoiseOverTime
end
